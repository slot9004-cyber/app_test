#==============================================================================
#
#  Copyright (c) 2016-2025 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
class Config(object):
    def __init__(self, cfg_file, cfg_from_json, outputbasedir, devicelist, hostname, deviceostype, userbuffer_mode, perfprofile, profilinglevel, cdsp, enable_init_caching):
...
class ConfigFactory(object):
    ...
    @staticmethod
    def make_config(cfgfile, outputbasedir, devicelist, hostname, usedevicesconnected, deviceostype, userbuffer_mode, perfprofile, profilinglevel, cdsp, enable_init_caching):
        ...
        if not os.path.exists(dlc_path):
            ...
            return Config(cfgfile, _config_from_json, outputbasedir, devicelist, hostname, deviceostype, userbuffer_mode, perfprofile, profilinglevel, cdsp, enable_init_caching)
